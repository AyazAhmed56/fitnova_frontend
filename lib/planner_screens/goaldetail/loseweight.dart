...
class LoseWeightDetails extends StatefulWidget {
  const LoseWeightDetails({super.key});

  @override
  State<LoseWeightDetails> createState() => _LoseWeightDetailsState();
}

class _LoseWeightDetailsState extends State<LoseWeightDetails> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(title: const Text("Lose Weight"), centerTitle: true),
              ...
              child: SingleChildScrollView(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Center(
                      child: Text(
                        "Let's build your personalized fat-loss journey.",
