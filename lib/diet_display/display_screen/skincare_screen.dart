  ...
  Widget build(BuildContext context) {
    Future<void> generatePdf(
      ...
      await Printing.sharePdf(
        ...
        filename: "skin_care_routine.pdf",
      );
    }
    ...
    return Container(
      ...
      child: Scaffold(
        ...
        appBar: AppBar(centerTitle: true, title: const Text("Skin Care")),
                      ...
                      child: Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Text(
                              "Generate a new AI meal plan to receive a fresh skin care routine.",
