...
class CooldownScreen extends StatefulWidget {
  ...
  const CooldownScreen({super.key, required this.workoutDay});
...
class _CooldownScreenState extends State<CooldownScreen> {
  ...
  List<CooldownModel> get cooldowns => widget.workoutDay.coolDown;

  double get progress {
    if (cooldowns.isEmpty) return 0;
    return (_currentIndex + 1) / cooldowns.length;
  }

  void _nextExercise() {
    if (_currentIndex < cooldowns.length - 1) {
    ...
    if (cooldowns.isEmpty) {
      return Container(
        ...
        child: Scaffold(
          ...
          appBar: AppBar(title: const Text("Cool Down")),
          body: const Center(
            child: Text(
              "No Cool Down Exercises",
                  ...
                  children: [
                    ...
                    Row(
                      children: [
                        ...
                        Text(
                          "${_currentIndex + 1} / ${cooldowns.length}",
                          style: TextStyle(
                            color: Colors.white,
                          ...
                          Expanded(
                            child: ElevatedButton(
                              ...
                              child: Row(
                                ...
                                children: [
                                  Text(
                                    _currentIndex == cooldowns.length - 1
                                        ? "Finish"
                                        : "Next",
                                    style: const TextStyle(
                                      color: Colors.black,
