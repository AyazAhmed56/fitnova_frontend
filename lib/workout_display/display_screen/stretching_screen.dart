...
import '../widget/stretching_card.dart';

class StretchingScreen extends StatefulWidget {
  final WorkoutDayModel workoutDay;

  const StretchingScreen({super.key, required this.workoutDay});
...
class _StretchingScreenState extends State<StretchingScreen> {
  ...
  List<StretchingModel> get stretches => widget.workoutDay.stretching;

  double get progress {
    if (stretches.isEmpty) return 0;
    return (_currentIndex + 1) / stretches.length;
  }

  void _nextExercise() {
    if (_currentIndex < stretches.length - 1) {
                  ...
                  children: [
                    ...
                    Row(
                      children: [
                        ...
                        Text(
                          "${_currentIndex + 1} / ${stretches.length}",
                  ...
                  itemBuilder: (context, index) {
                    ...
                    return SingleChildScrollView(
                      ...
                      child: Column(
                        children: [
                          _CatalogGif(
                            future: _catalogFor(stretch.exerciseName),
                          ),
                          const SizedBox(height: 14),
                          StretchingCard(
                            stretching: stretch,
                          ...
                          Expanded(
                            child: ElevatedButton(
                              ...
                              child: Row(
                                ...
                                children: [
                                  Text(
                                    _currentIndex == stretches.length - 1
                                        ? "Finish"
                                        : "Next",
                                    style: const TextStyle(
                                      color: Colors.black,
